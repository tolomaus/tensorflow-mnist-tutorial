...
def training_step(i, update_test_data, update_train_data):
    ...
    if update_test_data:
        a, c, im = sess.run([accuracy, cross_entropy, It], feed_dict={X: notmnist.test.images, Y_: notmnist.test.labels})
        datavis.append_test_curves_data(i, a, c)
        datavis.update_image2(im)
        print(str(i) + ": ********* epoch " + str(
            i * 100 // notmnist.train.images.shape[0] + 1) + " ********* test accuracy:" + str(a) + " test loss: " + str(
            c))
